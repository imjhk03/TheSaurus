...
/*
 * 이 액티비티는 메인 액티비티에서 도서 리스트 버튼을 누르면 보여지는 도서 리스트 화면을 구성하는 액티비티
 * 다음 책 검색 api 를 이용해서 입력한 텍스트를 전체, 제목, 저자 별로 검색할 수 있고
 * 또한 바코드 검색도 가능하게 설정함.
 * 태그를 이용한 검색은 지금 현재 기능 구현 안 되어 있음. 화면만 나타남.
 */
public class BookActivity extends AppCompatActivity implements BookAdapter.BookAdapterOnClickHandler {
...
//        GridLayoutManager layoutManager = new GridLayoutManager(this, 3);
    ...
    private void onBarcodeButtonClicked(View view) {
        IntentIntegrator integrator = new IntentIntegrator(BookActivity.this);
    ...
    private void onSearchButtonClicked(View view) {
        ...
        if (searchText.getText().toString().equals("")) {
            ...
            // 다음 검색 api를 이용하여 json 데이터를 불러오게 하는 함수
        ...
        protected List<Book> doInBackground(String... params) {
            ...
            try {
                ...
                List<Book> simpleJsonBookData = OpenBookJsonUtils
                        .getSimpleBookStringsFromJson(BookActivity.this, jsonBookResponse);
